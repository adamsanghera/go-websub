...
func (sc *Server) subscribe(topic string) error {
...
func (sc *Server) processSubscriptionResponse(resp *http.Response, topicURL string, callbackURI string, unsub bool) error {
